...
$(document).ready(function () {
    ...
    // Kolla href också ;PPP ifall man ba får sidan länkad hehehe
    if (location.hash) {
        var trie = /\#(.*)\-/.exec(location.hash);
        var id = trie[1];
        ...
        setTimeout(
            function () {
                $('html,body').animate({
                    ...
                    'slow', 'swing', function () {
                        $$('.col-md-3').css('top', $(window).scrollTop() - 130);
                    });
            }, 500);

    }

    $$('.doc_child_item').click(function () {
        var $obj = $$("#" + $(this).attr('data-id'));
        $('html,body').animate({
                scrollTop: $obj.offset().top
            },
            'slow', 'swing', function () {
                $$('.col-md-3').css('top', $obj.offset().top - 130);
            });
    });
